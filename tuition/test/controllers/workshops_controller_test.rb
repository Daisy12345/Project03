...
class WorkshopsControllerTest < ActionController::TestCase
  ...
  test "should create workshop" do
    assert_difference('Workshop.count') do
      post :create, workshop: { date: @workshop.date, duration: @workshop.duration, name: @workshop.name, no_of_students: @workshop.no_of_students, price: @workshop.price, user_id: @workshop.user_id }
    end
  ...
  test "should update workshop" do
    patch :update, id: @workshop, workshop: { date: @workshop.date, duration: @workshop.duration, name: @workshop.name, no_of_students: @workshop.no_of_students, price: @workshop.price, user_id: @workshop.user_id }
    assert_redirected_to workshop_path(assigns(:workshop))
  end
